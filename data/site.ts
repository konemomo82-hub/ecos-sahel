...
export const donation = {
  mali: {
    ...
    bank: {
      name: "BNDA (Banque Nationale de Développement Agricole)",
      agency: "Agence de Kalaban-Coro",
      holder: "Association ECOS",
      address_fr: "Rue 435, porte 14, Baco Djicoroni Heremakono, Bamako, Mali",
      address_en: "Rue 435, porte 14, Baco Djicoroni Heremakono, Bamako, Mali",
      codeBanque: "ML043",
      codeGuichet: "01009",
